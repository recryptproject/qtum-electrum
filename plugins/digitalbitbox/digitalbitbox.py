...
try:
    ...
    from recrypt_electrum.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, \
    ...
    from recrypt_electrum.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
